...
function IconLogout({ className }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" /></svg>;
}
function IconArrowLeft({ className }: { className?: string }) {
  return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" /></svg>;
}

const navItems = [
  { label: "Dashboard", href: "/admin/dashboard", icon: IconDashboard },
  { label: "Artigos", href: "/admin/artigos", icon: IconArticle },
  { label: "Fontes", href: "/admin/fontes", icon: IconLink },
  { label: "Podcast", href: "/admin/podcast", icon: IconHeadphones },
  { label: "Newsletter", href: "/admin/newsletter", icon: IconMail },
  { label: "Config", href: "/admin/configuracoes", icon: IconSettings },
];
    ...
    <div className="flex min-h-screen">
      <aside className="w-60 border-r border-white/[0.06] bg-[#0a1628] flex flex-col">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all duration-200 ${
                  pathname === item.href
                    ? "bg-[#EA1D2C]/10 text-[#EA1D2C] font-medium"
        ...
        <div className="p-2 border-t border-white/[0.06]">
          <Link href="/" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-white/40 hover:text-white/70 hover:bg-white/[0.04] transition-all">
            <IconArrowLeft className="w-4 h-4" />
            Ver Blog
          </Link>
          <Button variant="ghost" className="w-full justify-start gap-3 text-sm text-white/40 hover:text-white/70 rounded-xl" onClick={handleLogout}>
